...
namespace KK_StudioAccessoryNames
{
    public static class Hooks
    {
        ...
        private static void AccessoriesInfo_UpdateInfo_ChangeLabels(OCIChar _char) => KK_StudioAccessoryNames.instance.StartCoroutine(KK_StudioAccessoryNames.UpdateStudioLabelsDelayed(_char));
